    ...
    <fieldset>
        ...
        <section class="col-2">
            ...
            <select id="plan-start-time" class="col-2" name="planning_start_time">
                <?php for ($i = 1 ; $i < 24 ; $i++) : ?>
                <option value="<?= $i ?>"<?= $i == Config::get()->WHAKAMAHERE_PLANNING_START_HOUR ? ' selected' : '' ?>>
        ...
        <section class="col-2">
            ...
            <select id="plan-end-time" class="col-2" name="planning_start_time">
                <?php for ($i = 1 ; $i < 24 ; $i++) : ?>
                <option value="<?= $i ?>"<?= $i == Config::get()->WHAKAMAHERE_PLANNING_END_HOUR ? ' selected' : '' ?>>
                    <?= str_pad($i, 2, '0', STR_PAD_LEFT) ?>:00
                </option>
                <?php endfor ?>
            </select>
        ...
        <section>
            <input type="checkbox" name="show_weekends" id="plan-show-weekends"
    ...
    <fieldset>
        ...
        <section class="col-2">
            ...
            <select id="occupation-start-time" class="col-2" name="occupation_start_time">
                <?php for ($i = 1 ; $i < 24 ; $i++) : ?>
                    <option value="<?= $i ?>"<?= $i == Config::get()->WHAKAMAHERE_OCCUPATION_START_HOUR ? ' selected' : '' ?>>
                        <?= str_pad($i, 2, '0', STR_PAD_LEFT) ?>:00
                    </option>
                <?php endfor ?>
            </select>
        ...
        <section class="col-2">
            ...
            <select id="occupation-end-time" class="col-2" name="occupation_start_time">
                <?php for ($i = 1 ; $i < 24 ; $i++) : ?>
                    <option value="<?= $i ?>"<?= $i == Config::get()->WHAKAMAHERE_OCCUPATION_END_HOUR ? ' selected' : '' ?>>
                        <?= str_pad($i, 2, '0', STR_PAD_LEFT) ?>:00
                    </option>
                <?php endfor ?>
            </select>
